...
$Self->{'Package::RepositoryList'} =  {
  'http://ftp.otrs.org/pub/otrs/itsm/bundle5/' => '[--OTRS::ITSM 5 Bundle--] http://ftp.otrs.org/'
};
$Self->{'Ticket::Service'} =  '1';
$Self->{'CloneDB::LogFile'} =  '/tmp/OTRSCloneDB.log';
$Self->{'CloneDB::CheckEncodingColumns'} =  {
  'article.a_body' => '1',
  'article_attachment.filename' => '1'
};
...
$Self->{'CloneDB::SkipTables'} =  {
  'otrsclonedb_example_skip_table' => '1'
};
...
$Self->{'PreferencesGroups'}->{'UserITSMChangeManagementTemplateEdit'} =  {
  ...
  'Column' => 'Other Settings',
  'Data' => '',
  'Key' => 'Change and WorkOrder templates edited by this user.',
  'Label' => 'Change and WorkOrder templates edited by this user.',
  'Module' => 'Kernel::Output::HTML::Preferences::Generic',
...
$Self->{'PreferencesGroups'}->{'ChangeOverviewSmallPageShown'} =  {
  ...
  'DataSelected' => '25',
  'Key' => 'Change limit per page for Change Overview "Small"',
...
$Self->{'PreferencesGroups'}->{'UserCreateWorkOrderNextMask'} =  {
  ...
  'Key' => 'Show this screen after I created a new workorder',
...
delete $Self->{'Customer::AuthModule::LDAP::AccessAttr'};
delete $Self->{'Customer::AuthModule::LDAP::GroupDN'};
